...
{
    if (hit.collider.CompareTag("BouncyWall"))
    {
        // Reflect the character velocity off the wall normal
        CharacterVelocity = Vector3.Reflect(CharacterVelocity, hit.normal) * 0.8f;

        // Optional: Add an upward kick to simulate rope bounce
